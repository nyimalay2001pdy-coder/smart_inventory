...
if ($show_edit_id) {
    ...
    if ($edit_purchase) {
        $edit_details = mysqli_query($conn,
...
$view_details = null;
if ($show_view_id) {
    $view_purchase = mysqli_fetch_assoc(mysqli_query($conn,
    ...
    if ($view_purchase) {
        $view_details = mysqli_query($conn,
            "SELECT d.*, p.product_name FROM purchase_details d
             INNER JOIN products p ON d.product_id = p.id
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-12">
                                        <div class="empty-state">
                                            <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
        ...
        <form method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <select name="supplier_id" class="form-input">
                        <?php mysqli_data_seek($all_suppliers, 0); while ($s = mysqli_fetch_assoc($all_suppliers)): ?>
            ...
            <div class="overflow-x-auto mb-6">
                <table class="data-table">
                    ...
                    <tbody>
                        <?php $edit_total = 0; while ($row = mysqli_fetch_assoc($edit_details)): $edit_total += $row['subtotal']; ?>
                        <tr>
                            <td>
