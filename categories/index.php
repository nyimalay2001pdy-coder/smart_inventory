                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="center sticky right-0 bg-white z-10">
                                                    <div class="actions">
                                                        <a href="view.php?id=<?= $row['id'] ?>" title="View" class="btn btn-sm inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors">
