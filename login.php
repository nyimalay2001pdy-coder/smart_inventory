...
<head>
    ...
    <style>
        ...
        .dark body { background: linear-gradient(135deg, #030712 0%, #0f172a 50%, #1e293b 100%); }
        .login-card { backdrop-filter: blur(20px); background: rgba(255, 255, 255, 0.97); }
        .dark .login-card { background: rgba(31, 41, 55, 0.97); }
    ...
    <div class="w-full max-w-md">
        <div class="login-card rounded-2xl shadow-2xl p-8 md:p-10">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Smart Inventory</h1>
                <p class="text-gray-500 dark:text-gray-400 mt-1">Sign in to your account</p>
            </div>

            <?php if ($error): ?>
                <div class="flex items-center gap-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-3 rounded-xl mb-6 text-sm font-medium">
            ...
            <form method="POST" class="space-y-5" autocomplete="off">
                <div>
                    ...
                    <input type="email" name="email" required value="<?= htmlspecialchars($email ?: $remembered_email) ?>"
                        class="input-field w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 transition-all"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="password" required id="password"
                            class="input-field w-full px-4 py-3 pr-12 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 transition-all"
                            placeholder="Enter your password">
                        <button type="button" onclick="togglePassword()"
                            class="toggle-pw absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
