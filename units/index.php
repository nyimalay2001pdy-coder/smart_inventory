                                            ...
                                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                                                ...
                                                <td class="px-4 py-3 center sticky right-0 bg-white dark:bg-slate-800 z-10">
                                                    <div class="actions">
                                                        ...
                                                        <a href="?action=delete&id=<?= $u['unit_id'] ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this unit?')" class="btn btn-sm inline-flex items-center justify-center w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
